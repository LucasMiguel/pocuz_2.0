...
function BtnPlayPause(props) {
    ...
    var icon = props.isPlay ?
        ...
        </svg> : <svg width="45" height="45" viewBox="0 0 100 100" className={`fill-white`} xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <button className={`flex shadow-sm shadow-slate-500 justify-center items-center w-[70px] h-[70px] border-2 hover:scale-105 bg-[${color}] border-none rounded-[44px]`} onClick={props.click}>
            {icon}
        </button>
    );
}
